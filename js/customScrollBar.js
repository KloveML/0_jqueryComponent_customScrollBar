...
(function ($) {
    ...
    var customScrollBar = (function () {
        ...
        customScrollBar.prototype.renderScrollBarX = function () {
            var $element = this.$element, options = this.options, scaleX = this.scaleX, scaleY = this.scaleY, $scrollBoxX = $('<dic class="t-scrollBoxX"></div>').css(options.scrollBoxCssX), $scrollBarX = $('<div class="t-scrollBarX"></div>').css(options.scrollBarCssX), sBoxHeightX = options.scrollBoxCssX.height, sBoxWidthY = options.scrollBoxCssY.width;
            var sBoxWidthX = $element.outerWidth(), sBarWidthX = sBoxWidthX * scaleX;
        ...
        customScrollBar.prototype.renderScrollBarY = function () {
            var $element = this.$element, options = this.options, scaleX = this.scaleX, scaleY = this.scaleY, $scrollBoxY = $('<dic class="t-scrollBoxY"></div>').css(options.scrollBoxCssY), $scrollBarY = $('<div class="t-scrollBarY"></div>').css(options.scrollBarCssY), sBoxWidthY = options.scrollBoxCssY.width, sBoxHeightX = options.scrollBoxCssX.height;
            var sBoxHeightY = $element.outerHeight(), sBarHeightY = sBoxHeightY * scaleY;
        ...
        customScrollBar.prototype.bindScrollBarY = function () {
            ...
            var originY, top = 0; //记录scrollbar在scrollbox的相对位置
            //声名滚轮滚动事件类型
